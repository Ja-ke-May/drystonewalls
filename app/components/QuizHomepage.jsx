...
const QuizHomepage = () => {
  ...
  return (
    <div className="relative mt-20 z-20">
      <div id="quiz-homepage-container" className="p-6 bg-black bg-opacity-80 mx-auto text-center text-white md:max-w-[100%]">
        <div className="text-xl flex items-center justify-center inset-x-0 mb-4">
        <h3 className='underline hover:text-green-600 font-bold'><Link href="/quiz" passHref>Test your knowledge</Link></h3>
        </div>
