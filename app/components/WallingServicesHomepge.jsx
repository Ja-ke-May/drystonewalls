  ...
  return (
    <div className="relative mt-20 z-20">
      <div id="welcome-container" className="p-6 bg-black bg-opacity-80 mx-auto text-center text-white md:max-w-[100%]">
        ...
        <span className='underline hover:text-green-600'><Link href="/wallingservices" passHref>Walling Services</Link></span>
        </div>
...
export default WallingServicesHomepge;