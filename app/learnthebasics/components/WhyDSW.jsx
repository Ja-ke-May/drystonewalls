...
const WhyDSW = () => {
  return (
    <div className="relative mt-20 z-20">
      <section id="why-dsw" className="p-6 bg-black bg-opacity-80 mx-auto text-center text-white md:max-w-[75%]">
      <div className="text-xl flex items-center justify-center inset-x-0 mb-4">
        <h3 className='font-bold'>Why do we need dry stone walls?</h3>
        </div>
