  ...
  return (
    <>
      <div className='h-full flex'>
        <p className='md:ml-8 md:text-lg font-mono'>{date}</p>
      </div>

      <div className='menu-background w-2 pt-2 ml-5 md:ml-20'>
        <div className="flex flex-row">
          <div className='flex flex-col text-right'>
            <h3 className='text-2xl md:text-2xl text-green-600 p-2'>{title}</h3>
            <p className='md:text-lg p-2'>{info}</p>
            <a href={link} target="_blank" rel="noopener noreferrer" className='underline text-green-600 p-2'>{linkText}</a>
            <img 
              src={image} 
