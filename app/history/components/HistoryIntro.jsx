...
const HistoryIntro = () => {
  ...
  return (
    <div className="relative z-20 ">
      ...
      <p className='mt-2 md:text-lg '>If you know an interesting moment in the history of dry stone walling, let me know. 
      <br />
      <span className='underline hover:text-green-600'><Link href="/contact" passHref>Contact</Link></span> me and I'll add to the timeline. 
      </p>
      </section>
    </div>
  );
